...
- [ ] Replay the complete suite from a clean checkout or GitHub Actions at the reviewed PR head and retain the workflow URL, runtime/dependency versions, commands, and logs.
