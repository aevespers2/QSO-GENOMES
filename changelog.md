...
- These remain candidate claims: they are not merged or release-approved, no commit status or workflow run is attached to head `9de3db6a33308346d09b7004e6702e997dce9ba8`, and review findings remain unresolved.

### Review findings
- Reachable submitted-state provenance must replace references to inaccessible or non-ancestor intermediate commits.
