...
PR #2 is the single canonical submission path. Its submitted head includes the exact-set, immutable-migration, Aequitas-integrity, provenance, documentation, and immutable artifact-binding remediation lineage. The local-ethics validation branch extends canonical submitted head `8c65748cfaa9a213d29d7f03d250a3f797bbb1a1` with a standard-library migration validator, exact canonical local-ethics list bindings for Atlas, Lyra, Nova, and Orion, and raw-list duplicate rejection before set/map conversion. The updated migration canonical digest is `7677a01c9ea9d35f3c8c3a84e4601c0ffa2ac289aaf65699771e25876bbf8926`, and the candidate path/hash set digest is `99f33227247ef39fef3e1c3206c8ea49b9be9af86148298f07bdbf00b0cd6921`. CPython 3.13.5 bytecode compilation, direct validator replay, and eight focused tests passed against an exact relevant-data fixture mirror at implementation/test ancestor `a75f23c3e91dea925ee5b97cc265bddb5ec7b1fc`. These remain candidate evidence, not accepted capability.

The remaining integrity gaps begin with duplicate Aequitas review-surface and conflicting oversight-definition rejection, followed by source-derived manifest identities, digest-scope semantics, dependency and workflow correction, exact-head clean replay, and review-thread disposition. No accepted workflow run is attached to the candidate.
